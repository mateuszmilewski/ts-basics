...
var a1 = 1; // od ecma6 juz mozna uzywac let const tak samo tj. i ts i js maja mozliwosc tworzenia takich deklaracji
var a2 = 2;
console.log("----------------------------------------");
...
// type assertions
console.log("----------------------------------------");
var msg; // to samo co let msg:any;
...
var msg2 = msg.substr(1, 2);
var msg3 = msg.substr(2, 3);
...
(function () { return console.log("uruchamiamy funkcje anonimowa bez parametrow"); });
...
var narysujPunktPrymitywnie = function (x, y) {
...
var narysujPunktNiecoLepiej = function (punkt) {
    console.log(punkt);
};
var narysujPunktNiecoNiecoLepiej = function (_a) {
    var x = _a.x, y = _a.y;
...
var narysujPunktTypy = function (point) {
...
var narysujPunktZInterfejsem = function (mojPunkt) {
...
var LepszyPunkt = /** @class */ (function () {
...
var p1 = new LepszyPunkt(1, 2);
var p2 = new LepszyPunkt(4, 6);
var p3 = new LepszyPunkt();
...
var Klasa = /** @class */ (function () {
    ...
    // public is default
    Klasa.prototype.foobar = function () {
        console.log("wywoluje foobar");
    };
    Klasa.prototype.foobar2 = function () {
        console.log("wywoluje foobar 2!");
    };
    Klasa.prototype.showMe = function () {
        console.log("show me: " + this.zmienna1 + ", " + this.zmienna2);
    };
    Klasa.prototype.przypiszWartosciDoZmiennych = function (arg1) {
